...
export const useRecetasStore = defineStore('recetas', {
  ...
  actions: {
    ...
    async obtenerRecetas() {
      try {
        const response = await axios.get('https://api-perla.onrender.com/api/v1/recetas')
    ...
    async obtenerReceta(titulo) {
      try {
        const response = await axios.get(`https://api-perla.onrender.com/api/v1/recetas/${titulo}`)
