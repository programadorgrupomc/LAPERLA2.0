...
export default {
  ...
  updateDataCultOrgG(id, body) {
    return axios.put(`https://api-perla.onrender.com/api/v1/update-culturaorg/${id}`, body)
  },
  ...
  updateDataFilosofiaG(id, body) {
    return axios.put(`https://api-perla.onrender.com/api/v1/update-nuestrafilosofia/${id}`, body)
  },
  ...
  updateDataPptNosG(id, body) {
    return axios.put(`https://api-perla.onrender.com/api/v1/update-pptnosotros/${id}`, body)
  },
  ...
  updateDataTimeline(id, body) {
    return axios.put(`https://api-perla.onrender.com/api/v1/update-timeline/${id}`, body)
  }
}
