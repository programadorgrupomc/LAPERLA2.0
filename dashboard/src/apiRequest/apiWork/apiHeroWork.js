...
export default {
  ...
  updateDataHwG(id, body) {
    return axios.put(
      `https://api-perla.onrender.com/api/v1/update-herowork/${id}`,
      body
    );
  },
  getDataPpptWorkG() {
  ...
  updateDataPptWorkG(id, body) {
    return axios.put(
      `https://api-perla.onrender.com/api/v1/update-pptwork/${id}`,
      body
    );
  },
  ...
  updateDataCodEtiWorkG(id, body) {
    return axios.put(
      `https://api-perla.onrender.com/api/v1/update-codetiwork/${id}`,
      body
    );
  },
