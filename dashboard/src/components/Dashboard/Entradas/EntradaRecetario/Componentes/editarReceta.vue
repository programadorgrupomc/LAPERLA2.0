  ...
  <div class="cont-nuevarecetagen">
    ...
    <div v-for="receta in recetas">
      ...
      >
        ...
        <div class="img-rec2">imagen editable</div>
      </div>
              ...
              <div class="swiper-container h-full">
                <div class="swiper-wrapper h-full">
                  <div
                    ...
                    :key="index"
                  >
                    <button class="bg-white absolute right-0 m-5 p-2 rounded-2xl hover:bg-red-300">
                      Eliminar
                    </button>
            ...
            <div class="cont-preparacion font-KarbonRegular">
              ...
              <div class="desc-pre text-left">
                <ul
                  contenteditable="true"
                  class="list-decimal"
                  @input="capturarPreparacion($event)"
                >
