...
<template>
    <div class="bg-FondoPerla">
        ...
        <div id="form4" class="form4" v-show="currentForm === 4">
            ...
            <div class="envio bg-FondoPerla flex justify-start lg:justify-start py-8 lg:py-1">
                <div class="flex justify-end">
                    <button @click="scrollToForm4back" class="back-form4 px-4 lg:px-8 text-white font-TestKarbonRegular"
                        type="button">Anterior</button>
                </div>
            </div>
            ...
            <div class="bg-FondoPerla">
                ...
                <div class="descicionbtn flex flex-col lg:flex-row lg:justify-evenly items-center">
                    ...
                    <button class="btnesc lg:order-first font-TestKarbonMedium" type="reset">CANCELAR</button>
                </div>
            </div>
        </div>
    </div>
