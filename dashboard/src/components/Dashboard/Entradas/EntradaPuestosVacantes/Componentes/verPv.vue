...
<template>
    <div>
        <div class="flex justify-end">
            <button @click="cambiarestadopv" class="btn-back flex items-center"> <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div v-for="pv in puestosVacantes" class="cont-workdes">
            <div v-if="pv._id === idpv" class="lg:columns-2 lg:flex lg:items-center cont-text">
                <div class="imagen-round bg-violet-400 rounded-full m-auto">
                    <img loading="lazy" class="h-full w-full rounded-full" src="../../../assets/AssetsWork/imgwork1(1).jpg"
                        alt="imagen circular" />
                </div>
                <div class="ttl-work lg:w-2/4">
                    ...
                    <div class="cont-salary">
                        <p class="salary-work font-KarbonRegular text-right text-AzulPerla">Sueldo: S/.{{ pv.sueldo }}</p>
                    </div>
                </div>
            </div>
        </div>
