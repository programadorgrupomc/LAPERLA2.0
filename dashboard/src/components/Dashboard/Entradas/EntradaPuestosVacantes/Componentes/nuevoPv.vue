...
export default {
    ...
    methods: {
        cambiarEstado() {
            ...
            this.$emit('estadonuevopvcam', this.estadonuevopv);
        },
...
<template>
    <div v-if="estadonuevopv" class="nuevo-pv">
                ...
                <div class="ttl-work lg:w-2/4">
                    ...
                    <div class="cont-salary">
                        <p class="salary-work font-KarbonRegular text-right text-AzulPerla">Sueldo: S/.<span
                                class="spn-salary" contenteditable="true">000</span></p>
                    </div>
                </div>
            </div>
        </div>
