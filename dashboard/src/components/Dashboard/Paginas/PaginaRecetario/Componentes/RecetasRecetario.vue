<template>
    <div class="recetario bg-FondoPerla">
        <div class="recetario-titulo">
            <p class="titulo">RECETARIO</p>
        </div>
            ...
            <div class="recetas columns-2">
                <div v-for="receta in recetas" :key="receta.id" class="receta ">
                        ...
                        <div class="w-full h-full relative flex justify-center items-center">
                            ...
                            <p contenteditable="true" class="border receta-titulo font-bold text-center absolute text-white">{{ receta.nombre }}</p>
                        </div>
...
<script>
import receta1Image from "../../../../../assets/Dashboard/Recetario/receta1.jpg";
