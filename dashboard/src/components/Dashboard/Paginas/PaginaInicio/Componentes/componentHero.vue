<template>
    <div class="w-full h-full relative">
        ...
        <div class="relative h-screen z-30 w-full lg:h-full flex justify-center items-center" v-if="!previewUrl">
            ...
            <input type="file" @change="handleFileChange" class="bg-red-50 h-1/4 w-1/4 opacity-0" />
        </div>
        <div v-if="previewUrl" class="h-full w-full bg-violet-300">
            <img :src="previewUrl" v-if="isImage" class="w-full" />
