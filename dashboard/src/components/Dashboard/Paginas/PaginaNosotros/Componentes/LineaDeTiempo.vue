        ...
        <div v-for="(time, index) in data" :key="index"
            ...
            <div class="contenido flex-col flex justify-around lg:flex-row lg:items-center">
                <div class="contenido-txt-img flex flex-col lg:flex-row lg:items-center">
                    <div class="txt">
                        <h1 contenteditable="true" class="border txt-h1 flex justify-center items-center lg:justify-end"
                            :class="'txt-h1' + index">{{
                                time.titulo }}</h1>
                        <p contenteditable="true" class="border txt-p m-auto lg:m-0 flex justify-center items-center"
                            :class="'txt-p' + index">{{
                                time.contenido }}</p>
                    </div>
                    <div class="img m-auto">
                        <!-- <img src="../../assets/Nosotros/imgtimel1.png" class="img-tl" :class="'img-tl' + index" alt=""> -->
                        <FileUploaderRect />
                    </div>
                </div>
            ...
            <div class="linea shadow-2xl absolute flex justify-center items-center" :class="'linea' + index">
                <img v-if="index === 0" class="punta absolute top-0"
                    src="../../../../../assets/Dashboard/Nosotros/TriangleTimeLine.svg" alt="">
