...
export default {
    ...
    methods: {
        ...
        updateStatus() {
            api.updateDataGnf(this.idnotFound, { status: this.notfoundData.status })
                .then(response => {
    ...
    <div class="contendorPages ">
        ...
        <div class="h-screen">
            ...
            <div class="flex flex-col lg:flex-row items-center apt2">
                <div class="break-inside-avoid lg:w-1/4 ">
                    ...
                    <div class="cont-upload flex justify-center items-center p-2 object-cover w-40 border-2 relative">
                        <img src="../../assets/cDashboard/Iconmaterial-perm-media.svg" alt=""
                            class="absolute w-full h-full">
                        <input type="file" name="" id="" class="absolute w-full h-full z-50 opacity-0"
            ...
            <div class="apartado-mat flex justify-between items-center bg-white">
                ...
                <button @click="() => alert('Cambios Guardados!')"
                    class="btn-publicar bg-NaranjaPerla text-white">Publicar</button>
            </div>
            <div class="apartado-mat flex justify-between items-center bg-white">
                <p>Web en mantenimiento</p>
                <input type="checkbox" id="switch" /><label @click="saveCheckBox" class="toogle" for="switch">Toggle</label>
            </div>
        </div>
    </div>
</template>
