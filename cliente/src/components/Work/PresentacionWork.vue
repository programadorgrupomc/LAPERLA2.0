  ...
  <div class="">
    ...
    <div v-if="pptData"
      ...
      <div class="bloque1 absolute flex flex-col h-screen justify-center items-center">
        <img loading="lazy" class="imgpptn1 object-cover" src="@/assets/Work/imgppt1.png" alt="Imgb1" />
      ...
      <div class="bloque2 absolute flex flex-col  h-screen justify-center items-center">
        <img loading="lazy" class="imgpptn2 object-cover" src="@/assets/Work/imgppt2.png" alt="Imgb2" />
      ...
      <div class="bloque3 absolute flex flex-col  h-screen justify-center items-center">
        <img loading="lazy" class="imgpptn3 object-cover" src="@/assets/Work/imgppt3.png" alt="Imgb3" />
