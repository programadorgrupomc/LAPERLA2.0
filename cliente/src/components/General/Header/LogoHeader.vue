<template>
  <div class="logo flex justify-center items-center relative">
    <img
      src="../../../assets/General/logo-laperla.png"
      class="logo-img w-full h-full"
      alt="logo-laperla"
    />
    <img
      src="../../../assets/General/star-logo-laperla.png"
      class="logo-star-img absolute"
      alt="star-logo-laperla"
    />
  </div>
</template>
...
export default {
  ...
  methods: {
    animationLogo() {
      const logocont = document.querySelector('.logo-img')

      const animationL1 = gsap.to('.logo-img', {
        paused: true,
        duration: 0.3,
        scale: 1.1
      })

      const animationL12 = gsap.to('.logo-star-img', {
        paused: true,
        duration: 0.3,
        rotate: 30,
        y: -5,
