    ...
    <div class="conttrianglegen hidden h-screen md:flex justify-center items-end">
      <div class="imgtrianglenf1 relative flex justify-center items-center">
        <img
          ...
          src="@/assets/Nosotros/nftriangle(1).svg"
          alt=""
        />
      ...
      <div class="trianglecentral relative flex justify-center items-center">
        <img
          loading="lazy"
          class="w-full h-full object-cover"
          src="@/assets/Nosotros/nftriangle(3).svg"
          alt=""
        />
      ...
      <div class="imgtrianglenf2 relative flex justify-center items-center">
        <img
          loading="lazy"
          class="w-full h-full object-cover"
          src="@/assets/Nosotros/nftriangle(2).svg"
          alt=""
        />
  ...
  methods: {
    animarFilosofia() {
      ...
      if (window.innerWidth < 768) {
        ...
        tlnf.fromTo('.conttritem2', { opacity: 0, yPercent: -30 }, { opacity: 1, yPercent: 7 })
        tlnf.fromTo(
          '.trianglecentral',
          { opacity: 0, yPercent: -30 },
        ...
        tlnf.fromTo('.conttritem1', { opacity: 0, yPercent: 30 }, { opacity: 1, yPercent: 9 }, 0)
        tlnf.fromTo(
          ' .imgtrianglenf1',
          { opacity: 0, yPercent: 30 },
          { opacity: 1, yPercent: 0 },
        ...
        tlnf.fromTo('.conttritem3', { opacity: 0, yPercent: 30 }, { opacity: 1, yPercent: 8 }, 0)
        tlnf.fromTo('.imgtrianglenf2', { opacity: 0, yPercent: 30 }, { opacity: 1, yPercent: 0 }, 0)
      }
    },
    actualizarAnimacion() {
